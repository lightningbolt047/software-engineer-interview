...
<img src="explanation_screenshots/SEC-303.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-401.png" width="50%" height="auto">

But in my opinion, this is not the best way to handle it. It must fail loudly!
So, I changed it to this:
<img src="explanation_screenshots/PERF-401-1.png"  width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-405.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-405-1.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-406.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-406-2.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-408.png" width="50%" height="auto">

Also, we're not closing the single connection as well, so I'm closing it after using.

<img src="explanation_screenshots/PERF-408-1.png" width="50%" height="auto">
...
Added a last used at column in the DB which gets updated each time the user makes a request using this token.
...
One of the fixes that I had mentioned in PERF-406 would fix this as well.
...
<img src="explanation_screenshots/VAL-201-1.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-201-2.png" width="50%" height="auto">

#### VAL-205: Zero Amount Funding:
Added validation to check if the amount is greater than 0.

<img src="explanation_screenshots/VAL-205.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-205-1.png" width="50%" height="auto">

#### VAL-207: Routing Number Optional:
Added validation to check if account type is bank, and then check if it's not empty.

<img src="explanation_screenshots/VAL-207.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-210-2.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-402.png" width="50%" height="auto">
...
<img src="explanation_screenshots/PERF-404.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-203.png" width="50%" height="auto">

Added it to the zod schema as well.

<img src="explanation_screenshots/VAL-203-1.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-204.png" width="50%" height="auto">
...
<img src="explanation_screenshots/VAL-209.png" width="50%" height="auto">

#### UI-101: Dark Mode text Visibility:
Fixed it for input fields, but we should be doing this for the whole app:

<img src="explanation_screenshots/UI-101.png" width="50%" height="auto">

Bonus: I fixed the text visibility for the dashboard header, all radio button labels, and the $ sign preceding the funding amount input in dark mode.

Had to add a fixed text color (color was the same as the light mode text color) since we're not darkening the background.
